...
from .ippo_extragradient_self_adaptive import IppoSelfAdaptiveExtraGradient, IppoSelfAdaptiveExtraGradientConfig, SelfAdaptiveExtraGradientOptimizer, SelfAdaptiveExtraGradientCallback
...
from .ippo_projection_contraction import IppoPCVI, IppoPCVIConfig, PCExtraGradientAdam, ProjectionContractionCallback
...
classes = [
    ...
    "IppoSelfAdaptiveExtraGradient",
    "IppoSelfAdaptiveExtraGradientConfig",
    "SelfAdaptiveExtraGradientOptimizer",
    "SelfAdaptiveExtraGradientCallback",
    "IppoVINoNorm",
    "IppoVINoNormConfig",
    "VIOptimizerNoNorm",
...
algorithm_config_registry = {
    ...
    "ippo_extragradient_self_adaptive": IppoSelfAdaptiveExtraGradientConfig,
    "ippo_vi_no_norm": IppoVINoNormConfig,
    "ippo_vi_no_anchor": IppoVINoAnchorConfig,
    "ippo_projection_contraction": IppoPCVIConfig,
    "maddpg": MaddpgConfig,
    "iddpg": IddpgConfig,
    "masac": MasacConfig,
    "isac": IsacConfig,
