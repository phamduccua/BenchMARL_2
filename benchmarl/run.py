...
def _build_callbacks(algorithm_name: str, task_name: str, cfg: DictConfig):
    ...
    elif algorithm_name == "ippo_extragradient_self_adaptive":
        from benchmarl.algorithms.ippo_extragradient_self_adaptive import SelfAdaptiveExtraGradientCallback
        callbacks.append(SelfAdaptiveExtraGradientCallback())
