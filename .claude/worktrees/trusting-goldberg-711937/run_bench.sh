...
for algo in "$@"; do
    case "$algo" in
        ...
        ippo_vi|ippo_vi_no_norm|ippo_vi_no_anchor)
            ...
            ;;
        ippo_extragradient_adaptive_nu095)
            run_algo "ippo_extragradient_adaptive" "ippo_extragradient_adaptive_nu095" \
                "algorithm.extra_nu=0.95" "algorithm.extra_rho=1e-4" "algorithm.extra_min_scale=0.1"
            ;;
        ippo_extragradient_adaptive_nu05)
            run_algo "ippo_extragradient_adaptive" "ippo_extragradient_adaptive_nu05" \
                "algorithm.extra_nu=0.5" "algorithm.extra_rho=1e-4" "algorithm.extra_min_scale=0.1"
            ;;
        ippo_extragradient_adaptive_ms001)
            run_algo "ippo_extragradient_adaptive" "ippo_extragradient_adaptive_ms001" \
                "algorithm.extra_min_scale=0.01"
            ;;
        ippo_extragradient_adaptive_ms05)
            run_algo "ippo_extragradient_adaptive" "ippo_extragradient_adaptive_ms05" \
                "algorithm.extra_min_scale=0.5"
            ;;
        ippo_extragradient_adaptive)
            run_algo "ippo_extragradient_adaptive" "ippo_extragradient_adaptive"
            ;;
        *)
            run_algo "$algo" "$algo"
            ;;
